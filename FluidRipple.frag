...
void main() {
    ...
    // Enhanced multi-frequency waves (larger amplitudes + faster phase speeds for pronounced undulation)
    float w1 = sin(angle * 10.0 - ubuf.progress * 8.0) * 0.06;
    float w2 = cos(angle * 19.0 + ubuf.progress * 12.0) * 0.03;
